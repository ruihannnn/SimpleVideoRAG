...
class VideoRAG:
    ...
    def load_caption_model(self, debug=False):
        ...
        if not debug:
            ...
            self.caption_model = AutoModel.from_pretrained(caption_model_path, trust_remote_code=True)
            self.caption_tokenizer = AutoTokenizer.from_pretrained(caption_model_path, trust_remote_code=True)
